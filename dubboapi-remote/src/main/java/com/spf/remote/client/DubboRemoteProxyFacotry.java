...
/*
 * 修订记录:
 * turalyon@jinvovo.com 2017-03-13 15:18 创建
 *
 */
package com.spf.remote.client;
 ...
 * </pre>
 */
@Component("dubboRemoteProxyFacotry")
				...
				if (cachedReferenceConfig == null) {
					...
					try {
						...
						try {
							...
							throw new RuntimeException("获取dubbo服务失败,销毁Invoker失败:"
													   + e.getMessage() + ",cause:"
													   + e.getMessage());
						}
